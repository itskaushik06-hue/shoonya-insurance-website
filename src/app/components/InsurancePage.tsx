...
export function InsurancePage() {
  return (
    <div className="min-h-screen bg-white page-transition">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className={sectionHero.compact.rightColumn}>
              ...
              <p
                ...
                `}
              >
                Insurance tailored to your business, people, property, and risk profile in India.
                <br />
      ...
      >
        <Grid>
          <PolicyItem name="Health Insurance" description="Comprehensive medical coverage for you and your family, including hospitalization, surgeries, preventive care, and long-term protection planning." href="/health-insurance" />
      ...
      >
        <Grid>
          ...
          <PolicyItem name="Group Health Insurance" description="Group health insurance for employees that supports retention, workforce well-being, and employer cost planning." href="/group-health-insurance" />
          ...
          <PolicyItem name="Property Insurance" description="Commercial property insurance for offices, facilities, and business assets exposed to fire, catastrophe, and operational disruption." href="/property-insurance" />
          ...
          <PolicyItem name="Professional Indemnity" description="Professional indemnity insurance for firms and consultants facing legal liabilities arising from services and advice." href="/professional-indemnity-insurance" />
          <PolicyItem name="Liability Insurance" description="Business liability insurance against third-party claims for bodily injury, property damage, and legal exposure." href="/liability-insurance" />
        </Grid>
      </Category>
      ...
      >
        <Grid>
          ...
          <PolicyItem name="Machinery Breakdown" description="Protection against unexpected machinery failures, repair costs, and business interruption risk." href="/machinery-breakdown-insurance" />
          ...
          <PolicyItem name="Industrial Property Insurance" description="Industrial property insurance for factories, warehouses, stock, and mission-critical infrastructure." href="/industrial-property-insurance" />
        </Grid>
      </Category>
      ...
      >
        <Grid>
          <PolicyItem name="Marine Insurance" description="Marine cargo insurance for goods in transit by sea, air, or land, including cargo and logistics exposure." href="/marine-cargo-insurance" />
          <PolicyItem name="Cyber Insurance" description="Cyber insurance for companies facing data breaches, ransomware, network interruption, and digital liability risk." href="/cyber-insurance" />
