      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto space-y-10 text-grey-700 leading-relaxed">
          ...
          <div>
            ...
            <p>
              Shoonya Insurance Brokers Private Limited respects your privacy
          ...
          <div>
            ...
            <p>
              ...
              details, identification information, policy details, and other
              relevant data necessary for insurance advisory and brokerage
              services.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Information collected is used to assess risk, provide insurance
              advisory services, facilitate policy placement, manage claims
              support, comply with regulatory obligations, and improve service
              quality.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              We may share information with insurers, regulatory authorities,
              service providers, and legal entities as required to deliver
              services or comply with legal obligations. We do not sell
              personal data.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              fulfill service requirements and regulatory obligations.
            </p>
          </div>
          ...
          <div>
            <h2>7. Your Rights</h2>
            <p>
              You may request access, correction, or clarification regarding
              your personal data by contacting us through the details provided
              on our website.
            </p>
          </div>
