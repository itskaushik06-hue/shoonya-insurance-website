 ...
 */
const SECTION_Y = "py-20";            // vertical rhythm (Home uses same)
const HERO_MIN_H = "min-h-[85vh]";    // hero height (reduce/increase)
const HERO_TITLE = "text-5xl";        // main title size
const HERO_SUB = "text-1xl";           // descriptor size
const HERO_SUPPORT = "text-base";     // supporting line
const CARD_GAP = "gap-6";             // spacing between journey cards
const CARD_MAX_W = "max-w-6xl";       // journey container width
    ...
    <div className="min-h-screen bg-white page-transition">
      ...
      >
        <div className="text-center max-w-3xl space-y-5">
          ...
          <div className="pt-4 flex justify-center">
            {/* Matches Home default CTA scale */}
      ...
      <section className={`px-6 ${SECTION_Y}`}>
        ...
        {/* 
          ...
          - Second row: 2 cards perfectly centered as a group
          - Tablet: 2 columns
          - Mobile: 1 column
        */}
        <div
